  ...
  return (
    <div className="flex items-center gap-2">
      <button
        ...
        type="button"
        className={`px-2 py-1 text-sm cursor-pointer transition-opacity ${currentLocale === 'en' ? 'font-bold opacity-100' : 'opacity-60 hover:opacity-100'}`}
      ...
      <button
        ...
        type="button"
        className={`px-2 py-1 text-sm cursor-pointer transition-opacity ${currentLocale === 'sq' ? 'font-bold opacity-100' : 'opacity-60 hover:opacity-100'}`}
